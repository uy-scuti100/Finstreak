...
const Navbar = () => {
   ...
   return (
      <nav className="max-w-[1104px] mx-auto h-[50px] md:px-[88px] px-[20px] lg:mb-[4.5rem] pt-10 fixed top-0 left-0 right-0 w-screen bg-white lg:static z-50">
         <div className="flex justify-between items-center">
            {/* logo and name`` */}
            <Link href="/" className="cursor-pointer bg-white w-screen">
            ...
            {/* navLinks */}
            <ul
               className={`flex transition-all duration-500 lg:flex-row items-center top-[70px] w-full lg:w-auto lg:h-auto lg:pt-0 h-full pt-10 gap-10 lg:static absolute ${
                  open ? "left-0 bg-white h-[50vh]" : "-left-full"
               } flex-col`}>
